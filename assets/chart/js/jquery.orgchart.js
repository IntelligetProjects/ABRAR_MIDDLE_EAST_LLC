...
(function (factory) {
  ...
  var OrgChart = function (elem, opts) {
    ...
    this.defaultOptions = {
      'nodeTitle': 'name',
      'nodeId': 'id',
      'img': 'https://omantel.teamway.om/assets/images/avatar.jpg',
  ...
  OrgChart.prototype = {
    ...
    createNode: function (data) {
      ...
      var $nodeDiv = $('<div' + (opts.draggable ? ' draggable="true"' : '') + (data[opts.nodeId] ? ' data-img="' + data[opts.img] + '" id="' + data[opts.nodeId] + '"' : '') + (data.parentId ? ' data-parent="' + data.parentId + '"' : '') + '>')
