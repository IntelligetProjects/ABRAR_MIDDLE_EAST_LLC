...
class Projects extends MY_Controller {
    ...
    function view($project_id = 0, $tab = "") {
        ...
        $expense_access_info = $this->get_access("can_access_expenses");

        $view_data["show_expense_info"] = (get_setting("module_expense") && $expense_access_info->access_type == "1") ? true : false;



        $po_access_info = $this->get_access("can_access_purchase_orders");

        $view_data["show_po_info"] = ($po_access_info->access_type == "1") ? true : false;



        $accesspay_info = $this->get_access("can_access_invoice_payments");

        $view_data["show_pay_info"] = (get_setting("module_invoice") && $accesspay_info->access_type == "1") ? true : false;
    ...
    private function _get_projects_dropdown() {
        ...
        //// to add tasks without project mesam

        $projects_dropdown = array("1" => "-");
...
if($project_id=='0'){
    ...
    private function _make_task_row($data, $custom_fields) {
        ...
        if ($this->can_delete_tasks()) {
            ...
            $options .= js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_task'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("projects/delete_task"), "data-action" => "delete-confirmation"));
    ...
    function purchase_orders($project_id) {
        ...
        if ($project_id) {
            ...
            $this->load->view("projects/purchase_orders/index", $view_data);
    ...
    function geo_location($project_id) {
        ...
        if ($project_id) {
            ...
            $this->load->view("projects/geo_location", $view_data);

        }

    }
    function budgeting($project_id) {
        ...
        if ($project_id) {
            ...
            $this->load->view("projects/budgeting/index", $view_data);
