...
if (!function_exists('estimates_statistics_widget')) {
    ...
    function estimates_statistics_widget($return_as_data = false)
    {
        ...
        $info = $ci->Reports_model->quotations_statistics($options);
        ...
        foreach ($estimates as $key => $estimate) {
            $estimates_array[] = array($key, $estimate);
        }
        ...
        return $ci->load->view("reports_view/quotation_to_invoices_chart", $view_data, $return_as_data);
    }
}
