...
<table class="table-responsive" style="width: 100%; color: #444;">
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        <th style="width: 30%; border-right: 1px solid #eee;"> <?php echo lang("item"); ?> </th>
        ...
        <th style="text-align: right;  width: 15%; border-right: 1px solid #eee;"> <?php echo lang("discount"); ?></th>
    ...
    ?>
        ...
        <tr style="background-color: #f4f4f4; ">
            <td style="width: 30%; border: 1px solid #fff; padding: 10px;"><?php echo $item->title; ?>
                <br />
            ...
            <td style="text-align: right; width: 15%; border: 1px solid #fff;"> <?php echo to_currency($discount, "no"); ?></td>
            <td style="text-align: right; width: 15%; border: 1px solid #fff;"> <?php echo to_currency($item->total - $discount + $tax, "no"); ?></td>
        </tr>
    <?php } ?>
    <tr>
        <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo lang("total"); ?></td>
    ...
    <?php if ($estimate_total_summary->tax_after_discount) { ?>
        <tr>
            <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo $estimate_total_summary->tax_name; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($estimate_total_summary->tax_after_discount); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($estimate_total_summary->tax2) { ?>
        <tr>
            <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo $estimate_total_summary->tax_name2; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($estimate_total_summary->tax2); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($estimate_total_summary->item_discount) { ?>
        <tr>
            <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo lang("discount"); ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($estimate_total_summary->item_discount); ?>
            </td>
        </tr>
    <?php } ?>
    <?php
