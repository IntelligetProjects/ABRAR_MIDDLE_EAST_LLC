<table id="estimate-item-table" class="table display dataTable text-right strong table-responsive">     
    ...
    <?php if ($estimate_total_summary->tax_after_discount) { ?>
        <tr>
            ...
            <td><?php echo to_currency($estimate_total_summary->tax_after_discount, $estimate_total_summary->currency_symbol); ?></td>
            <td></td>
        </tr>
    <?php } ?>
    ...
    <?php
   if($estimate_total_summary->item_discount){
    $discount_row = "<tr>
                        <td style='padding-top:13px;'>" . lang("discount") . "</td>
                        <td style='padding-top:13px;'>" . to_currency($estimate_total_summary->item_discount, $estimate_total_summary->currency_symbol) . "</td>";
   }                
