...
<div class="clearfix">
    <?php if ($show_invoice_info) { ?>
        ...
        <?php } ?>
        <?php if($total_sales_return){?>
        <div class="col-md-2 col-sm-6  widget-container">
                <?php $this->load->view("clients/info_widgets/tab", array("tab" => "total_sales_return")); ?>
            </div>
        <?php } ?>
        <?php if($total_invoices){?>
        <div class="col-md-2 col-sm-6  widget-container">
                <?php $this->load->view("clients/info_widgets/tab", array("tab" => "total_invoices")); ?>
            </div>
        <?php } ?>
