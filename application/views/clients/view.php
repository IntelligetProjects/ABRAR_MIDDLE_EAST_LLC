...
<div id="page-content" class="clearfix">
    ...
    <div class="mt15">
        <?php $this->load->view("clients/info_widgets/index",array("total_sales_return"=>$total_sales_return)); ?>
    </div>
    ...
    <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php if ($show_invoice_info) { ?>
            ...
            <li><a  role="presentation" href="<?php echo_uri("clients/sales_return/" . $client_info->id); ?>" data-target="#client-sales_return"> <?php echo lang('sales_return'); ?></a></li>
        ...
        <li><a  role="presentation" href="<?php echo_uri("clients/geo_location/" . $client_info->id); ?>" data-target="#client-geo_location"> <?php echo lang('geo_location'); ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="client-sales_return"></div>
        ...
        <div role="tabpanel" class="tab-pane" id="client-geo_location" style="min-height: 300px"></div>
    </div>
</div>
