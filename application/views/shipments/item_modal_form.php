<?php echo form_open(get_uri("shipments/save_item"), array("id" => "estimate-item-form", "class" => "general-form", "role" => "form")); ?>
...
$(document).ready(function () {
    $("#estimate-item-form").appForm({
        onSuccess: function (result) {
            $("#shipment-item-table").appTable({newData: result.data, dataId: result.id});
        }
    });
