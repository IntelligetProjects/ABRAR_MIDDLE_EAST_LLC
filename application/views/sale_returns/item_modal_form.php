<?php echo form_open(get_uri("sale_returns/save_item"), array("id" => "estimate-item-form", "class" => "general-form", "role" => "form")); ?>
...
$(document).ready(function () {
    $("#estimate-item-form").appForm({
        onSuccess: function (result) {
            $("#sale_return-item-table").appTable({newData: result.data, dataId: result.id});
        }
    });
