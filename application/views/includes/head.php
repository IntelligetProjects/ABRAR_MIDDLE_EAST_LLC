...
*/    
    ...
    if(@get_setting('user_' . $this->login_user->id . '_personal_language') == 'arabic')
    {
        load_css(array(        
        "assets/css/custom-style-rtl.css",
        "assets/css/app.all-rtl.css",
    ));
    }

    load_js(array(
        "assets/js/app.all.js",
        "assets/js/apexchart/apexcharts.js",

        "assets/js/jstree.js",
        "assets/js/jstree.search.js",
        "assets/chart/js/jquery.orgchart.js",
        "assets/js/stacktable.js",

        /*
        "assets/js/apexchart/apexcharts.min.js",
        "assets/js/apexchart/apexcharts.amd.js",
        "assets/js/apexchart/apexcharts.common.js",
        "assets/js/apexchart/apexcharts.esm.js",*/
    ));
    ?>
