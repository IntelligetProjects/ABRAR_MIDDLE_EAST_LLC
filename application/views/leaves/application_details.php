    ...
    <div class="row">
        ...
        <div class="table-responsive mb15">
            <table class="table dataTable display b-t">
                ...
                <tr>
                    <td class="w100"> <?php echo lang('paid_?'); ?></td>
                    <td>
                    <?php echo form_open(get_uri("leaves/update_paid_unpaid"), array("id" => "leave-paid-unpaid-form", "class" => "general-form", "role" => "form")); ?>
        
                    <div class="col-md-4">
                        <input type="hidden" name="id" value="<?php echo $leave_info->id; ?>" />
                        <?php
                        echo form_dropdown("paid_unpaid", $paid_unpaid_dropdown, $leave_info->paid_unpaid, "class='form-control  select2 validate-hidden' id='paid_unpaid' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                        ?>
                    </div>
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-success btn-sm  update-leave-paid-unpaid"><span class="fa fa-check-circle-o"></span> <?php echo lang('save'); ?></button>
                    </div>
                        <?php echo form_close(); ?>
                ...
                <?php }else{ ?>
                    <tr>
                    <td class="w100"> <?php echo lang('paid_?'); ?></td>
                    <td><?php echo ($leave_info->paid_unpaid)?'Paid':'Unpaid'; ?></td>
                </tr>
                <?php } ?>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#leave-paid-unpaid-form").appForm({
            onSuccess: function() {
                location.reload();
            }
        });
