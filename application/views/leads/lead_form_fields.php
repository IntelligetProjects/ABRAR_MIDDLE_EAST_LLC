...
<div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
        ...
        echo form_dropdown("lead_status_id", isset($lead_status)?$lead_status:'', array($model_info->lead_status_id), "class='select2'");
        ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="website" class="<?php echo $label_column; ?>"><?php echo lang('email'); ?></label>
    <div class="<?php echo $field_column; ?>">
        <?php
        echo form_input(array(
            "id" => "email",
