...
<div class="modal-body clearfix import-item-modal-body">
    <div id="upload-area">
        ...
        $this->load->view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("items/upload_excel_file"),
...
<div class="modal-footer">
    <?php echo anchor("items/download_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), array("title" => lang("download_sample_file"), "class" => "btn btn-default pull-left")); ?>
