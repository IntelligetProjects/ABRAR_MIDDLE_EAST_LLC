...
<div class="modal-body clearfix">
    ...
    <div class="clearfix">
        ...
        <div class="col-md-4 col-sm-4 form-group go-right-rtl">
            <?php
            echo form_input(array(
                "id" => "start_date",
                "name" => "start_date",
        ...
        <label for="start_time" class="go-right-rtl col-md-2 col-sm-2"><?php echo lang('start_time'); ?></label>
    ...
    <div class="clearfix">
        ...
        <div class="go-right-rtl col-md-4 col-sm-4 form-group">
            <?php
            echo form_input(array(
                "id" => "end_date",
                "name" => "end_date",
        ...
        <label for="end_time" class="go-right-rtl col-md-2 col-sm-2"><?php echo lang('end_time'); ?></label>
        <div class=" col-md-3 col-sm-3">
            <?php
