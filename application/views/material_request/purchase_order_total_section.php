<table id="purchase_order-item-table" class="table display dataTable text-right strong table-responsive">
    <tr>
        ...
        <td style="width: 120px;"><?php echo to_currency(isset($purchase_order_total_summary->purchase_order_subtotal)?$purchase_order_total_summary->purchase_order_subtotal:0, $purchase_order_total_summary->currency_symbol); ?></td>
