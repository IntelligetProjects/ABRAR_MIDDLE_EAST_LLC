<?php echo form_open(get_uri("material_request/save_item"), array("id" => "purchase_order-item-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
    <input type="hidden" name="material_request_id" value="<?php echo $material_request_id; ?>" />
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#purchase_order_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("material_request/get_purchase_order_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("material_request/get_purchase_order_item_info_suggestion"); ?>",
