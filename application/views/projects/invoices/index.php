    ...
    $(document).ready(function() {
        ...
        $("#invoice-table").appTable({
            ...
            columns: [
                ...
                {title: "<?php echo lang("file") ?>", "class": "w10p text-right"},
            ...
            summation: [{column: 8, dataType: 'currency', currencySymbol: currencySymbol}, {column: 9, dataType: 'currency', currencySymbol: currencySymbol},{column: 10, dataType: 'currency', currencySymbol: currencySymbol}]
