        ...
        <div class="col-md-12">
            ...
            <ul id="project-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                <?php if ($this->login_user->user_type === "staff") { ?>
                    ...
                    <?php } ?>
                    <li><a role="presentation" href="<?php echo_uri("projects/geo_location/" . $project_info->id); ?>" data-target="#project-geo_location"> <?php echo lang('geo_location'); ?></a></li>
                    ...
                    <?php } ?>
                    <?php if ($show_invoice_info) { ?>
                        <li><a  role="presentation" href="<?php echo_uri("projects/budgeting/" . $project_info->id); ?>" data-target="#project-budgeting"> <?php echo lang('budgeting'); ?></a></li>  
                    <?php } ?>
                    <?php if ($show_pay_info) { ?>
                    ...
                    <?php if ($show_po_info) { ?>
                        <li><a  role="presentation" href="<?php echo_uri("projects/purchase_orders/" . $project_info->id); ?>" data-target="#project-purchase_orders"> <?php echo lang('purchase_orders'); ?></a></li>
                    <?php } ?>   
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="project-budgeting"></div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="project-purchase_orders"></div>
                <div role="tabpanel" class="tab-pane fade" id="project-geo_location"></div>
