...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#project-table").appTable({
            ...
            {name: "deadline", class: "w200",
                    options:[
                        {"id": "", "text": "<?php echo '- '.lang('deadline').' -' ?>"},
                        {"id": "expired", "text": "<?php echo lang('expired') ?>"},
                        {"id": moment().format("YYYY-MM-DD"), "text": "<?php echo lang('today') ?>"},
                        {"id": moment().add(1, 'days').format("YYYY-MM-DD"), "text": "<?php echo lang('tomorrow') ?>"},
                        {"id": moment().add(7, 'days').format("YYYY-MM-DD"), "text": "<?php echo sprintf(lang('in_number_of_days'), 7); ?>"},
                        {"id": moment().add(15, 'days').format("YYYY-MM-DD"), "text": "<?php echo sprintf(lang('in_number_of_days'), 15); ?>"}
                    ]},
                ],
