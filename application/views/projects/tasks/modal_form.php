        ...
        <?php if (!$project_id) { ?>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    echo form_dropdown("project_id", $projects_dropdown, array(0), "class='select2 validate-hidden' id='project_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
                </div>
            </div>
        <?php } ?>
