...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var options = {
          series: [<?php foreach ($task_data as $key => $data) {
              echo $data['data'].',';
          } ?>],
          chart: {
          width: 265,
        ...
        labels: [<?php foreach ($task_data as $key => $label) {
              echo '"'.$label['label'].'",';
          } ?>],
        responsive: [{
          breakpoint: 480,
        ...
        var chart = new ApexCharts(document.querySelector("#my-task-status-pai"), options);
        chart.render();
    });
</script>    