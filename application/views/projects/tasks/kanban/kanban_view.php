<div id="kanban-wrapper">
    ...
    <ul id="kanban-container" class="kanban-container clearfix">
        ...
        <?php foreach ($columns as $column) { ?>
            <li class="kanban-col" >
                <div class="kanban-col-title" style="background: <?php echo $column->color ? $column->color : "#2e4053"; ?>;"> <?php echo $column->key_name ? lang($column->key_name) : lang($column->title); ?> </div>
