<?php echo form_open(get_uri("team_members/add_team_member"), array("autocomplete"=>"off","id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
            ...
            <div class="form-group">
                <label for="role" class="col-md-3"><?php echo lang('nationality'); ?></label>
                <div class="col-md-9">
                    <?php
                    echo form_dropdown("nationality", $nationality, array(), "class='select2 validate-hidden' id='user-role' , data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
            ...
            <input type="text" id="fix" style="    opacity: 0;">
        ...
        <div role="tabpanel" class="tab-pane" id="job-info-tab">
            ...
            <div class="form-group">
                <label for="working_hours" class=" col-md-3"><?php echo lang('working_hours'); ?></label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "working_hours",
            ...
            <div class="form-group">
                <label for="yearly_leaves" class=" col-md-3"><?php echo lang('yearly_leaves'); ?></label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "yearly_leaves",
        ...
        <div role="tabpanel" class="tab-pane" id="account-info-tab">
            ...
            <div class="form-group ">
                <!-- <div class="col-md-12">  
                    <?php
                    echo form_checkbox("email_login_details", "0", false, "id='email_login_details'");
