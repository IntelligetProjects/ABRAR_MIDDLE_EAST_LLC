<?php echo form_open(get_uri("purchase_returns/save_item"), array("id" => "estimate-item-form", "class" => "general-form", "role" => "form")); ?>
...
$(document).ready(function () {
    $("#estimate-item-form").appForm({
        onSuccess: function (result) {
            $("#purchase_return-item-table").appTable({newData: result.data, dataId: result.id});
        }
    });
