...
<div class="modal fade" id="actionConfirmationModal" tabindex="-1" role="dialog" aria-labelledby="actionConfirmationModal" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 400px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="confirmationModalTitle"><?php echo lang('confirm') . "?"; ?></h4>
            </div>
            <div id="actionConfirmationModalContent" class="modal-body">
                <?php echo lang('are_you_sure'); ?>
            </div>
            <div class="modal-footer clearfix">
                <button id="actionConfirmButton" type="button" class="btn btn-warning" data-dismiss="modal"><i class=""></i> <?php echo lang("confirm"); ?></button>
                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> <?php echo lang('cancel'); ?></button>
            </div>
        </div>
    </div>
