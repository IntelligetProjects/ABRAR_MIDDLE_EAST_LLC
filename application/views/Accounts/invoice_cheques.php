<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="payment-received-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a id="monthly-payment-button"  role="presentation" class="active" href="javascript:;" data-target="#monthly-payments"><?php echo lang("yearly"); ?></a></li>
        </ul>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade" id="team_member-monthly-leaves">
            ...
            <script type="text/javascript">
                ...
                $(selector).appTable({
                source: '<?php echo_uri("cheques/invoice_payment_list_data/") ?>',
                        order: [[0, "asc"]],
                ...
                $(selector).on('click', '[data-act=update-cheque_status]', function () {
                    $(this).editable({
                        ...
                        value: $(this).attr('data-value'),
                        url: '<?php echo_uri("cheques/invoice_transaction") ?>' + '/' + $(this).attr('data-id'),
                        showbuttons: false,
                ...
                loadPaymentsTable("#monthly-invoice-payment-table", "yearly");
                });
            </script>
        </div>
