...
<table class="table-responsive" style="width: 100%; color: #444;">            
    ...
    <?php if ($purchase_order_total_summary->tax) { ?>
        <tr>
            <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo $purchase_order_total_summary->tax_name; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
    ...
    <?php if ($purchase_order_total_summary->tax2) { ?>
        <tr>
            <td colspan="4" style="<?php echo 'text-align: '.$total_section_align.';'?>"><?php echo $purchase_order_total_summary->tax_name2; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
