<?php echo form_open(get_uri("purchase_orders/save"), array("id" => "purchase_order-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />

    <div class="form-group">
        <label for="purchase_order_date" class=" col-md-3"><?php echo lang('date'); ?></label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                ...
                "class" => "form-control",
                "placeholder" => lang('purchase_order_date'),
    ...
    <div class="form-group">
        ...
        <div class=" col-md-9">
            <?php
            echo form_dropdown("purchase_order_supplier_id", $suppliers_dropdown, array($model_info->supplier_id), "class='select2 validate-hidden' id='purchase_order_supplier_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        setDatePicker("#purchase_order_date");
