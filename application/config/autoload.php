...
$autoload['model'] = array(
    ...
    'Enteries_model',
    'Reports_model',
    'Stock_adjustments_model',
    'Shipments_model',
    'Shipment_items_model',
    'Purchase_returns_model',
    'Purchase_return_items_model',
    'Sale_returns_model',
    'Sale_return_items_model',
    'Payroll_model',
    'Payroll_detail_model',
    'Salary_advance_model',
    'Loans_model',
    'Budgeting_model',
    'Budgeting_items_model',
    'Proforma_invoice_items_model',
    'Proforma_invoices_model',
    'Items_levels_model',
    'Nationality_model',
    'Proforma_invoice_payments_model',
    'Item_uom_model',
    'Sale_items_model',
    'Material_request_items_model',
    'Email_messages_model',
    'Demo_login_events_model',
